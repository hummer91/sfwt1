...
export function BlockPage() {
	...
	const text: LanguageText = {
		en: {
			...
			aboutTitle: "About Us",
			aboutContent:
				"SFLabs provides innovative solutions using cutting-edge AI technology. Our goal is to enrich people's daily lives through the power of technology.",
			productTitle: "AI Face Reading",
			productDescription: "Discover your fortune with just one photo",
			productContent:
				"Using state-of-the-art AI technology, we analyze users' photos and provide face reading results. Discover your personality, talents, and potential with just one photo.",
			...
			contactContent:
				"Want to know more about our product or need a custom solution? Contact our sales team.",
		...
		ko: {
			...
			aboutTitle: "회사 소개",
			aboutContent:
				"SFLabs는 최첨단 AI 기술을 활용하여 혁신적인 솔루션을 제공합니다. 우리의 목표는 기술의 힘으로 사람들의 일상을 더욱 풍요롭게 만드는 것입니다.",
			productTitle: "AI 관상 분석",
			productDescription: "사진 한 장으로 당신의 운세를 알아보세요",
			productContent:
				"최첨단 AI 기술을 활용하여 사용자의 사진을 분석하고 관상을 봐드립니다. 단 한 장의 사진으로 당신의 성격, 재능, 그리고 잠재력을 발견해보세요.",
			uploadPhoto: "사진 업로드",
			comingSoon: "곧 제공 예정",
			pricingTitle: "가격 안내",
			basicPlan: "기본 플랜",
			...
			contactTitle: "문의하기",
			contactContent:
				"제품에 대해 더 알고 싶으시거나 맞춤 솔루션이 필요하신가요? 저희 영업팀에 문의해주세요.",
		...
		<div className="min-h-screen bg-gradient-to-br from-purple-100 via-pink-100 to-blue-100">
			...
			<main className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
				<section id="about" className="mb-16">
					...
					<p className="text-gray-700 text-lg">{text[language].aboutContent}</p>
				</section>
					...
					<Card className="bg-white bg-opacity-70 backdrop-blur-md">
						<CardHeader>
							<CardTitle className="text-2xl">
								{text[language].productTitle}
							</CardTitle>
							<CardDescription className="text-lg">
								{text[language].productDescription}
							</CardDescription>
						</CardHeader>
						<CardContent>
							...
							<div className="flex items-center space-x-2">
								<Button asChild size="lg" disabled>
									<label className="cursor-not-allowed">
										...
										{text[language].uploadPhoto}
									</label>
								</Button>
								<span className="text-sm text-gray-500">
									{text[language].comingSoon}
								</span>
							</div>
						</CardContent>
					</Card>
					...
					<Card className="bg-white bg-opacity-70 backdrop-blur-md">
						<CardContent className="pt-6">
							<div className="grid md:grid-cols-3 gap-6">
								...
								<div className="border p-4 rounded-lg">
									<h3 className="text-xl font-semibold mb-2">
										{text[language].enterprisePlan}
									</h3>
									<p className="text-3xl font-bold mb-4">
										{text[language].inquiry}
									</p>
									<ul className="list-disc list-inside text-gray-700">
					...
					<Card className="bg-white bg-opacity-70 backdrop-blur-md">
						<CardContent className="pt-6">
							...
							<p className="mt-4 text-sm text-gray-500">
								{text[language].email}{" "}
								<a
									href="mailto:operations@sflabs.io"
									className="text-blue-600 hover:underline"
								>
									operations@sflabs.io
								</a>
							</p>
						</CardContent>
					</Card>
